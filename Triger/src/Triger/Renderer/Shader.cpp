...
namespace Triger {
	...
	Triger::Ref<Triger::Shader> ShaderLibrary::Load(const std::string& filepath)
	{
	...
	Triger::Ref<Triger::Shader> ShaderLibrary::Load(const std::string& name, const std::string& filepath)
	{
		auto shader = Shader::Create(filepath);
		Add(name, shader);
		return shader;
	...
	Triger::Ref<Triger::Shader> ShaderLibrary::Get(const std::string& name)
	{
