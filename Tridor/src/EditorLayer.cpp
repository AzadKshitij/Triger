...
namespace Triger {
	...
	void EditorLayer::OnUpdate(Triger::Timestep ts)
	{
		TR_PROFILE_FUNCTION();

		// Resize
		if (Triger::FramebufferSpecification spec = m_Framebuffer->GetSpecification();
	...
	void EditorLayer::OnImGuiRender()
	{
		...
		if (ImGui::BeginMenuBar())
		{
			if (ImGui::BeginMenu("File"))
			{
				...
				if (ImGui::MenuItem("Exit")) Triger::Application::Get().Close();
				ImGui::EndMenu();
			}
	...
	void EditorLayer::OnEvent(Triger::Event& e)
	{
